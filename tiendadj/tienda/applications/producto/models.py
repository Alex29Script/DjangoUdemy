...
#250 importando Managers para conectarlo con el modelo
from .managers import ProductoUsuarioManager
...
class Product(TimeStampedModel):
    ...
    #250 concetando el manager
    objects =ProductoUsuarioManager()
    #
